...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\pywebautomationframework'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\pywebautomationframework\Scripts\deactivate.nu'
